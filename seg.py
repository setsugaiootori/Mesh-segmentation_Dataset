...
"""制作图像总的训练集，验证集和测试集所需要的文件夹，例如训练集的文件夹中装有五个文件夹，这些文件夹分别装有一定比例的五类图像"""
...
if __name__=='__main__':
    data_path = 'D:\development-program\gratuatedesign\datesets/'
    source_path = 'D:\development-program\gratuatedesign\shapes\images/'
    train_path = 'D:\development-program\gratuatedesign\datesets/train/'
    validation_path = 'D:\development-program\gratuatedesign\datesets/validation/'
    test_path = 'D:\development-program\gratuatedesign\datesets/test/'
